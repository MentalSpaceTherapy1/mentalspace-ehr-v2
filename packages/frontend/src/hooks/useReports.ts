...
export function useReportQuickStats() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get(`${API_BASE}/quick-stats`);
...
export function useRevenueByClinicianReport(startDate?: Date, endDate?: Date) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(`${API_BASE}/revenue/by-clinician?${params}`);
      return response.data.data;
    },
...
export function useRevenueByCPTReport(startDate?: Date, endDate?: Date) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(`${API_BASE}/revenue/by-cpt?${params}`);
      return response.data.data;
    },
...
export function useRevenueByPayerReport(startDate?: Date, endDate?: Date) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(`${API_BASE}/revenue/by-payer?${params}`);
      return response.data.data;
    },
    enabled: !!(startDate && endDate),
  });
...
export function usePaymentCollectionReport(startDate?: Date, endDate?: Date) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(`${API_BASE}/revenue/collection?${params}`);
      return response.data.data;
    },
    enabled: !!(startDate && endDate),
  });
...
export function useKVRAnalysisReport(startDate?: Date, endDate?: Date) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(`${API_BASE}/productivity/kvr-analysis?${params}`);
      return response.data.data;
    },
    enabled: !!(startDate && endDate),
  });
...
export function useSessionsPerDayReport(startDate?: Date, endDate?: Date, clinicianId?: string) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await api.get(`${API_BASE}/productivity/sessions-per-day?${params}`);
      return response.data.data;
    },
    enabled: !!(startDate && endDate),
  });
...
export function useUnsignedNotesReport() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get(`${API_BASE}/compliance/unsigned-notes`);
      return response.data.data;
    },
...
export function useMissingTreatmentPlansReport() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get(`${API_BASE}/compliance/missing-treatment-plans`);
      return response.data.data;
    },
    enabled: false, // Manual trigger only
  });
...
export function useClientDemographicsReport() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get(`${API_BASE}/demographics/client-demographics`);
      return response.data.data;
    },
    enabled: false, // Manual trigger only
  });
