                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        {appointment.telehealthSession && ['SCHEDULED', 'CONFIRMED', 'CHECKED_IN'].includes(appointment.status) && (
                          <div className="mt-4">
                            <button
                              onClick={() => navigate(`/portal/telehealth/${appointment.id}`)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              {selectedAppointment.telehealthSession && ['SCHEDULED', 'CONFIRMED', 'CHECKED_IN'].includes(selectedAppointment.status) && (
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <button
                    onClick={() => {
                      ...
                      navigate(`/portal/telehealth/${selectedAppointment.id}`);
                    }}
                    className="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors"
                  >
                    Join Video Session
