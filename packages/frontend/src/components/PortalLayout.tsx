    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-lg font-semibold text-gray-900">MentalSpace</span>
          </div>
          <button
      ...
      <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex items-center space-x-3 px-6 py-6 border-b border-gray-200">
          ...
          <div>
            <div className="text-lg font-bold text-gray-900">MentalSpace</div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <button
            ...
            className="flex items-center space-x-3 w-full px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
