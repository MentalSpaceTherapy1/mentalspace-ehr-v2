...
export default function LineChart({
  ...
  const handleExport = async () => {
    if (chartRef.current) {
      await exportChartAsImage(chartRef.current, title || 'line-chart');
    }
  };

  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100 rounded-2xl shadow-lg overflow-hidden border border-blue-200 transition-all duration-300 hover:shadow-2xl" ref={chartRef}>
