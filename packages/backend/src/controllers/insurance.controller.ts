...
const insuranceSchema = z.object({
  ...
  insuranceCompanyId: z.string().min(1).or(z.literal('')).optional(),
  planName: z.string().min(1, 'Plan name is required'),
  planType: z.string().min(1, 'Plan type is required'),
  memberId: z.string().min(1, 'Member ID is required'),
  groupNumber: z.string().min(1).or(z.literal('')).optional(),
  effectiveDate: z.string().datetime('Invalid effective date'),
  terminationDate: z.string().datetime().or(z.literal('')).optional(),
  subscriberFirstName: z.string().min(1).or(z.literal('')).optional(),
  subscriberLastName: z.string().min(1).or(z.literal('')).optional(),
  subscriberDOB: z.string().datetime().or(z.literal('')).optional(),
  subscriberSSN: z.string().min(1).or(z.literal('')).optional(),
  relationshipToSubscriber: z.string().min(1).or(z.literal('')).optional(),
  copay: z.number().optional(),
  deductible: z.number().optional(),
  outOfPocketMax: z.number().optional(),
  lastVerificationDate: z.string().datetime().or(z.literal('')).optional(),
  lastVerifiedBy: z.string().min(1).or(z.literal('')).optional(),
