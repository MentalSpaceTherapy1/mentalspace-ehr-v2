...
const insuranceSchema = z.object({
  ...
  insuranceCompanyId: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  planName: z.string().min(1, 'Plan name is required'),
  planType: z.string().min(1, 'Plan type is required'),
  memberId: z.string().min(1, 'Member ID is required'),
  groupNumber: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  ...
  subscriberFirstName: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  subscriberLastName: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  subscriberDOB: z.preprocess((val) => (val === '' ? undefined : val), z.string().datetime().optional()),
  subscriberSSN: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  relationshipToSubscriber: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  ...
  lastVerifiedBy: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  verificationNotes: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
});
