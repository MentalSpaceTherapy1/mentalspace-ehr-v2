...
const insuranceSchema = z.object({
  ...
  insuranceCompanyId: z.union([z.string().min(1), z.literal('')]).optional(),
  planName: z.string().min(1, 'Plan name is required'),
  planType: z.string().min(1, 'Plan type is required'),
  memberId: z.string().min(1, 'Member ID is required'),
  groupNumber: z.union([z.string().min(1), z.literal('')]).optional(),
  effectiveDate: z.string().datetime('Invalid effective date'),
  terminationDate: z.union([z.string().datetime(), z.literal('')]).optional(),
  subscriberFirstName: z.union([z.string().min(1), z.literal('')]).optional(),
  subscriberLastName: z.union([z.string().min(1), z.literal('')]).optional(),
  subscriberDOB: z.union([z.string().datetime(), z.literal('')]).optional(),
  subscriberSSN: z.union([z.string().min(1), z.literal('')]).optional(),
  relationshipToSubscriber: z.union([z.string().min(1), z.literal('')]).optional(),
  copay: z.number().optional(),
  deductible: z.number().optional(),
  outOfPocketMax: z.number().optional(),
  lastVerificationDate: z.union([z.string().datetime(), z.literal('')]).optional(),
  lastVerifiedBy: z.union([z.string().min(1), z.literal('')]).optional(),
  verificationNotes: z.union([z.string(), z.literal('')]).optional(),
});
