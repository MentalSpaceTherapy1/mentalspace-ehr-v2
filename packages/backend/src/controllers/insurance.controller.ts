...
const insuranceSchema = z.object({
  ...
  insuranceCompanyId: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
  planName: z.string().min(1, 'Plan name is required'),
  planType: z.string().min(1, 'Plan type is required'),
  memberId: z.string().min(1, 'Member ID is required'),
  groupNumber: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
  effectiveDate: z.string().datetime('Invalid effective date'),
  terminationDate: z.union([z.literal(''), z.string().datetime()]).transform(val => val === '' ? undefined : val).optional(),
  subscriberFirstName: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
  subscriberLastName: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
  subscriberDOB: z.union([z.literal(''), z.string().datetime()]).transform(val => val === '' ? undefined : val).optional(),
  subscriberSSN: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
  relationshipToSubscriber: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
  copay: z.number().optional(),
  deductible: z.number().optional(),
  outOfPocketMax: z.number().optional(),
  lastVerificationDate: z.union([z.literal(''), z.string().datetime()]).transform(val => val === '' ? undefined : val).optional(),
  lastVerifiedBy: z.union([z.literal(''), z.string().min(1)]).transform(val => val === '' ? undefined : val).optional(),
