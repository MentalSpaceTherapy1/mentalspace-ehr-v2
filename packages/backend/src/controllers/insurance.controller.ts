...
const insuranceSchema = z.object({
  ...
  insuranceCompanyId: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
  planName: z.string().min(1, 'Plan name is required'),
  planType: z.string().min(1, 'Plan type is required'),
  memberId: z.string().min(1, 'Member ID is required'),
  groupNumber: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
  effectiveDate: z.string().datetime('Invalid effective date'),
  terminationDate: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().datetime())),
  subscriberFirstName: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
  subscriberLastName: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
  subscriberDOB: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().datetime())),
  subscriberSSN: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
  relationshipToSubscriber: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
  copay: z.number().optional(),
  deductible: z.number().optional(),
  outOfPocketMax: z.number().optional(),
  lastVerificationDate: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().datetime())),
  lastVerifiedBy: z.preprocess((val) => val === '' ? undefined : val, z.optional(z.string().min(1))),
