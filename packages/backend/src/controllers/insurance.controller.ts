...
const insuranceSchema = z.object({
  ...
  insuranceCompanyId: z.union([z.literal(''), z.string().min(1)]).optional(),
  planName: z.string().min(1, 'Plan name is required'),
  planType: z.string().min(1, 'Plan type is required'),
  memberId: z.string().min(1, 'Member ID is required'),
  groupNumber: z.union([z.literal(''), z.string().min(1)]).optional(),
  effectiveDate: z.string().datetime('Invalid effective date'),
  terminationDate: z.union([z.literal(''), z.string().datetime()]).optional(),
  subscriberFirstName: z.union([z.literal(''), z.string().min(1)]).optional(),
  subscriberLastName: z.union([z.literal(''), z.string().min(1)]).optional(),
  subscriberDOB: z.union([z.literal(''), z.string().datetime()]).optional(),
  subscriberSSN: z.union([z.literal(''), z.string().min(1)]).optional(),
  relationshipToSubscriber: z.union([z.literal(''), z.string().min(1)]).optional(),
  copay: z.number().optional(),
  deductible: z.number().optional(),
  outOfPocketMax: z.number().optional(),
  lastVerificationDate: z.union([z.literal(''), z.string().datetime()]).optional(),
  lastVerifiedBy: z.union([z.literal(''), z.string().min(1)]).optional(),
