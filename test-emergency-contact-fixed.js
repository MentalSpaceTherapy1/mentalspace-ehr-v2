...
async function testEmergencyContact() {
  try {
    console.log('Testing emergency contact creation with correct schema...\n');

    // Transform like the controller does
    const testData = {
      clientId: 'fd871d2a-15ce-47df-bdda-2394b14730a4',
      name: 'Test Contact',  // Combined firstName + lastName
      relationship: 'Parent',
      phone: '555-0100',  // phoneNumber -> phone
      alternatePhone: '555-0101',
      email: 'test@example.com',
      address: '123 Test St',
      isPrimary: false,
      okayToDiscussHealth: false,  // Database field
      okayToLeaveMessage: true,    // Database field
    };
